...
const Body = () => {
  ...
  const handleSubmit = (e) => {
    ...
    if (value.semester)
      filtered = filtered.filter((stu) => stu.semester === Number(value.semester));
      ...
      <div className="space-y-5">
        ...
        <div className="flex-[0.8] mt-3">
          <div className="w-full border border-gray-300 rounded-lg shadow-md overflow-hidden">
            <div className="relative overflow-y-scroll max-h-[400px] min-h-[350px] pb-10">
                ...
                <tbody>
                  {filteredStudents.map((stu, idx) => (
                    <tr key={idx} className="min-h-[50px]">
                      ...
                      <td className="border border-gray-300 p-2 text-center">{stu.semester}</td>
                      <td className="border border-gray-300 p-2">{stu.department}</td>
                      <td className="border border-gray-300 p-2">{stu.batchName}</td>
